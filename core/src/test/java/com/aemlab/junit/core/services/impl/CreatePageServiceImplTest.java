...
class CreatePageServiceImplTest {
	 ...
	 private PageItem pageItem;
	    ...
	    void init()throws WCMException, RepositoryException {
	        ...
	        when(pageManager.create(JunitAppConstants.TEST_PAGE_ROOT, JcrUtil.createValidName(pageItem.getTitle()), JunitAppConstants.TEMPLATE_PATH, pageItem.getTitle(), false)).thenReturn(page);
